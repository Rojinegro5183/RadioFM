...
public class RadioService extends Service implements OnErrorListener,
	...
	public void onCreate() {
		...
		app_name = getResources().getString(R.string.app_name1);
		...
		STATUS_CONNECTING = getResources().getString(R.string.status_connecting);
	...
	public void showNotification() {
		...
		notifyBuilder = new NotificationCompat.Builder(this, "")
				.setSmallIcon(R.drawable.vista).setContentTitle(app_name)
				.setContentText("");
